                    ...
                    <div class="col-sm-8">
                      <div class="widget-box">
                        <div class="widget-header">
                          <h4 class="widget-title">ภาพเดิม</h4>
                        </div>
                          ...
                          <div class="widget-main">
                            ...
                            <div class="row">
                              ...
                              <div class="text-center">
                                  <img src="http://www.pro688.com/content/pro688/images/casino/SEXY-casino.png" alt="Smiley face" height="256" width="256">
										...
										<div class="col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">อัพโหลดภาพใหม่</h4>
												...
												<div class="widget-body">
													<div class="widget-main">
                              <form id="fb" action="update.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="element" name="element" value="<?php echo $element; ?>"/>
                              <br><br><br>
														<div class="form-group">
															<div class="col-xs-12">
																<input type="file" id="id-input-file-3" name="id-input-file-3" />
                                            <br><br>
															</div>
														</div>
